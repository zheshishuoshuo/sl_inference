...
def main():
    ...
    mock_lens_data.to_csv(os.path.join(os.path.dirname(__file__),"table" "mock_lens_data.csv"), index=True)
    mock_observed_data.to_csv(os.path.join(os.path.dirname(__file__), "mock_observed_data.csv"), index=True)
