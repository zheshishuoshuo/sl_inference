...
def run():
    ...
    res_cross = fit_halo_model_crossfit_fixed_xi(mock_lens_data=mock_lens_data)
    res_simple = fit_halo_model_simple_fixed_xi(mock_lens_data=mock_lens_data, params=res_cross)
